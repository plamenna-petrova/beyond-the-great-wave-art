      ...
      <div className="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <nav className="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
          <a href="/" className="navbar-brand ms-4 ms-lg-0">
            ...
            {/* <h1 className="fw-bold text-primary m-0">Beyond <span className="text-secondary">The Great</span> Wave Art</h1> */}
          </a>
              ...
              <img className="w-100" src={secondHomePageCarouseImage} alt={"Second Home Page Carousel Image"} />
                <div className="carousel-caption">
                  <div className="container">
                    <div className="row justify-content-start">
                      <div className="col-lg-7">
                        <h1 className="display-2 mb-5 animated slideInDown">Color is the keyboard, the eyes are the harmonies, the soul is the piano with many strings. The artist is the hand that plays, touching one key or another, to cause vibrations in the soul.</h1>
                      </div>
                    </div>
                  </div>
                </div>
