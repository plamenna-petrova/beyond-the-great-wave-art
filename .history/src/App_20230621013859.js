                ...
                <div className="container">
                  <div className="row justify-content-start">
                    <div className="col-lg-7">
                      <h1 className="display-2 mb-5 text-center animated slideInDown">To create one's world in any of the arts takes courage.</h1>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <img className="w-100" src={secondHomePageCarouseImage} alt={"Second Home Page Carousel Image"} />
                <div className="carousel-caption">
                  <div className="container">
                    <div className="row justify-content-start">
                      <div className="col-lg-7">
                        <h1 className="display-2 mb-5 text-center animated slideInDown">A true artist is not one who is inspired, but one who inspires others.</h1>
                      </div>
                    </div>
                  </div>
                </div>
