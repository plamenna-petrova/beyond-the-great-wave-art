...
export default function GalleriesSelection({ galleriesForSelection }) {
    return (
                    ...
                    <div className="tab-content">
                        <div id="tab-1" className="tab-pane fade show p-0 active">
                            <div className="row g-4">
                                {
                                    galleriesForSelection.slice(0, 8).map(galleryForSelection => (
                        ...
                        <div id="tab-2" className="tab-pane fade show p-0">
                            <div className="row g-4">
                                {
                                    galleriesForSelection.slice(8, 16).map(galleryForSelection => (
                                        <GallerySelectionCard gallerySelectionCardDetails={galleryForSelection} key={galleryForSelection.id} />
                                    ))
                                }
                        ...
                        <div id="tab-3" className="tab-pane fade show p-0">
                            <div className="row g-4">
                                {
                                    galleriesForSelection.slice(16, 24).map(galleryForSelection => (
                                        <GallerySelectionCard gallerySelectionCardDetails={galleryForSelection} key={galleryForSelection.id} />
                                    ))
                                }
                                <div className="col-12 text-center">
