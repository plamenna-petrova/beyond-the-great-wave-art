...
export default function GallerySelectionCard({ gallerySelectionCardDetails }) {
    return (
        <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div className="product-item">
                <div className="position-relative bg-light overflow-hidden">
                    <img className="img-fluid w-100" src={gallerySelectionCardDetails.image.src} alt={gallerySelectionCardDetails.image.alt} />
